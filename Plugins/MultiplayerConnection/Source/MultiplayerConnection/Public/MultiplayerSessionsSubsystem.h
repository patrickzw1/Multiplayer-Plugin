...
/**
* Declare our own delegate for custom class which is menu class in here to bind the callbacks to 
*/
 ...
 */
UCLASS()
class MULTIPLAYERCONNECTION_API UMultiplayerSessionsSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
public:
	...
	/**
	* To handle Session interface. The menu class can call this.
	*/
	...
	/**
	* our own delegate for custom class which is menu class in here to bind the callbacks to 
	*/
